...
Find the code [here](https://github.com/mikan-laboratory/ghost-easy-deploy).
...
1. Navigate to the [Ghost Easy Deploy repository](https://github.com/mikan-laboratory/ghost-easy-deploy).
...
1. Navigate to the [GhostRemix repository](https://github.com/mikan-laboratory/ghost-easy-deploy).
